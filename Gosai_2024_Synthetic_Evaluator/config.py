...
evaluator_base = "gosai_2024_synthetic_mpra"

# Name of the file being used for predictions
plasmid_backbone = "upstream_downstream_backbone.txt"
...
if os.path.exists("/.singularity.d"):
    ...
    input_file = "41586_2024_8070_MOESM14_ESM_clean.txt"
    ...
    input_file = "41586_2024_8070_MOESM14_ESM_clean_test.txt"
...
PLASMID_BACKBONE_INPUT_PATH = os.path.join(EVALUATOR_DATA_DIR, plasmid_backbone)
